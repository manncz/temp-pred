...
Download and shape actual temperatures to compare students predictions with the truth.
...
#reshape long and create columns for date, days lag, station, and min/mean/max
obs.temp <-  obs.temp %>%
