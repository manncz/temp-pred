...
Merge observed data onto each dataset of student predictions on date, station, days log, and statistic (all included in label as well), to ensure that everything is aligned.
...
Look at the overall root mean squared error for student & reference predictions.
